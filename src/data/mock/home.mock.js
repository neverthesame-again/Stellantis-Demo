...
export const homePageMock = {
  hero: {
    eyebrow: "STELLANTIS AI HUB PLATFORM",
    title: "One STELLANTIS",
  ...
  mission: {
    ...
    title: "AI That Works for Everyone at STELLANTIS",
    paragraphs: [
      "One Stellantis AI is a strategic initiative to embed intelligent automation across every domain of the enterprise—from software engineering and IT operations to automotive intelligence and governance—creating a seamlessly connected ecosystem that drives innovation, efficiency, and better mobility outcomes",
      "By unifying eight distinct AI domains under a single platform, One Stellantis AI eliminates silos, accelerates decision-making, and enables teams to discover, build, test, and scale AI solutions through demos, prototypes, intelligent agents, and collaborative project workspaces. Secure, scalable, and compliant by design, the platform empowers organizations to unlock the full potential of AI",
    ],
    pills: [
      {
