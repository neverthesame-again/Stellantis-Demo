...
export const homePageMock = {
  hero: {
    eyebrow: "STELLANTIS AI PLATFORM",
  ...
  mission: {
    ...
    paragraphs: [
      ...
      "By unifying distinct AI domains under a single platform, One Stellantis AI eliminates silos, accelerates decision-making, and enables teams to discover, build, test, and scale AI solutions through demos, prototypes, intelligent agents, and collaborative project workspaces. Secure, scalable, and compliant by design, the platform empowers organizations to unlock the full potential of AI",
    ],
    pills: [
      {
