    ...
    <div className="login-page">
      ...
      <div className="login-split">
        <div className="login-left">
          <div className="login-badge">Stellantis AI Platform</div>
          <h2>Welcome to the Future of Enterprise AI</h2>
          <p>
            Sign in to access personalized AI workspaces and co-pilots tailored for your domain and role across Stellantis AI Platform.
          </p>
