...
// UI Component for Stellantis AI Platform Chatbot with Responsive Desktop Sidebar & Mobile History Overlay
    ...
    <>
      ...
      {!isOpen && !hideFloat && (
        <div
          ...
          data-theme="dark"
          onClick={open}
          title="Open Stellantis AI Platform Assistant"
        >
        ...
        <div className="centene-chat-header">
          <div className="centene-chat-header-left">
            ...
            <div className="centene-chat-title">
              <div>Stellantis AI Platform Agent</div>
