...
export const AppHealthModal = ({ isOpen, onClose, app }) => {
  ...
  const isDownApp = app.statusType === 'danger' || app.status === 'Down' || app.title.toLowerCase().includes('stellantis client portal') || app.title.toLowerCase().includes('myunum for clients') || app.title.toLowerCase().includes('sales connect');
